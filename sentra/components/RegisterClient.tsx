        ...
        <div className="w-full bg-gray-400 flex flex-col items-center justify-center">
            <div className="h-153 p-1 bg-gray-300 rounded-lg border border-gray-500">
                <MoveableScrollAreaVertical className="sm:h-150 max-w-5xl rounded-lg shadow-2xl overflow-hidden bg-gray-800 grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="p-8 relative bg-gray-900 text-white flex flex-col justify-between">
                        ...
                        {/* Website Projekt README */}
                        <Link
                            href={`/readme?doc=project#${language === "de" ? "deutsche-sprache" : "english-language"}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="mb-9 px-6 py-2 rounded-xl hover:bg-gray-400 border border-gray-400 text-gray-400 hover:text-black text-center transition"
                        >
                            {t.officialWebsite}
                        </Link>
                    </div>
