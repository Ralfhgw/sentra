        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc ml-6 mb-4">
                    ...
                    <li>Transmitting the materials to another person or "mirroring" the materials on any other server</li>
                </ul>
            </section>
            ...
            <section className="mb-8">
                ...
                <p>
                    If you have any questions about these Terms of Use, please contact us at our website contact page.
                </p>
            </section>
        </div>
    );
