        ...
        const response = await openai.responses.create({
          ...
          input: [
            ...
            },
            {
              role: "user",
              content: `
Besuche die Webseite ${url}
und extrahiere alle Events am ${day}.
...
- keine HTML-Tags, keine Referenzen, keine Klammern mit Quellen
- alle am ${day} gelisteten Events müssen enthalten sein
- keine zusätzlichen Erklärungen, nur reine CSV
- Enthält die Seite keine Termine, dann erstelle nur diese Zeile:
  Kein Event gefunden;${day};-;${url};Für diesen Tag wurden keine Termine gefunden
`
            }
          ]
        });
